...
function Afiliar() {
  return (
    ...
    <div className={styles.razonafiliar}>
    <Image src="/img/tarjetadesclub/Clientesregresen.png" width={100} height={100} alt='Logo Beneficio Clientes'/>
    ...
    <div className={styles.razonafiliar}>
    <Image src="/img/tarjetadesclub/nuevosClientes.png" width={100} height={100} alt='Logo Beneficio Nuevos Clientes'/>
    ...
    <div className={styles.razonafiliar}>
    <Image src="/img/tarjetadesclub/clientesconozcan.png" width={100} height={100} alt='Logo Beneficio Clientes te Conozcan'/>
