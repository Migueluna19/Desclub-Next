...
function Serviciosem() {
  ...
  return (
    ...
    <img src="/img/EmpresaDesclub/beneficiosypromociones.png" width={30} height={30} alt='Imagen Beneficios'/>
    <h4>Beneficios y Promociones</h4>
    </div>
    </button>
    <button className={styles.boton} onClick={(e)=>handleDesplegar(2)}>
    <div className={styles.gridbeneficios}>
    <img src="/img/EmpresaDesclub/dinamicasysorteos.png" width={30} height={30} alt='Imagen Beneficios'/>
    <h4>Dinámicas y Sorteos</h4>
    </div>
    </button>
    <button className={styles.boton} onClick={(e)=>handleDesplegar(3)}>
    <div className={styles.gridbeneficios}>
    <img src="/img/EmpresaDesclub/programasdeincentivos.png" width={30} height={30} alt='Imagen Beneficios'/>
    <h4>Programas de Incentivos</h4>
    </div>
    </button>
    <button className={styles.boton} onClick={(e)=>handleDesplegar(4)}>
    <div className={styles.gridbeneficios}>
    <img src="/img/EmpresaDesclub/puntosyrecompensas.png" width={30} height={30} alt='Imagen Beneficios'/>
    <h4>Puntos y Recompensas</h4>
    </div>
    </button>
    <button className={styles.boton} onClick={(e)=>handleDesplegar(5)}>
    <div className={styles.gridbeneficios}>
    <img src="/img/EmpresaDesclub/asistenciasyexperiencias.png" width={30} height={30} alt='Imagen Beneficios'/>
